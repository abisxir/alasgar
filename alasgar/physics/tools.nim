...
proc isSphereIntersectsSphere*(ca: Vec3, ra: float32, cb: Vec3,
    rb: float32): bool =
  result = length(cb - ca) < ra + rb

proc isSphereIntersectsBox*(center: Vec3, radius: float32, vmin,
    vmax: Vec3): bool =
...
proc isRayIntersectsBox*(rayOrigin, rayNormalizedDirection: Vec3,
    rayLength: float32, vmin, vmax: Vec3,
...
proc isRayIntersectsTriangle*(rayOrigin, rayDirection, vertex0, vertex1,
    vertex2: Vec3, outIntersectionPoint: ptr Vec3): bool =
