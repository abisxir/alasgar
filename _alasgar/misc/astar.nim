...
func isNotBlocked(maze: openArray[int], width: int, n: (int, int)): bool = maze[
    n[0] + n[1] * width] == 0
...
proc findPath*(maze: openArray[int], width, height: int, start: (int, int),
    goal: (int, int), path: var seq[(int, int)]): bool =
  var
